        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 margin-top-30 margin-bottom-30">
                    ...
                    <img src="images/pic6.png" class="width-100" alt="imac">
                ...
                <div class="col-md-6 margin-top-50 margin-bottom-30">
                    ...
                    <a href="#" class="btn btn-lg btn-blue small">Discover More</a>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <div class="chart">
                        <div class="percentage test2" data-percent="82">
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <h5 class="chart-title">More Customers</h5>
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <h5 class="chart-title">Bounce Rate</h5>
                ...
                <div class="col-sm-6 col-md-3">
                    ...
                    <h5 class="chart-title">Returning Visitors</h5>
